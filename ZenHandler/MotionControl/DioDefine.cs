...
namespace ZenHandler.MotionControl
{
    public class DioDefine
    {
        ...
        public enum DIO_IN_ADDR_CH1 : uint
        {
            ...
            //
            IN_LOAD_PICKER_VACUUM_ON1       = 0x00000001,            //17
            IN_LOAD_PICKER_VACUUM_ON2       = 0x00000002,
            IN_LOAD_PICKER_VACUUM_ON3       = 0x00000004,
            IN_LOAD_PICKER_VACUUM_ON4       = 0x00000008,            //20
            IN_LOAD_PICKER_VACUUM_OFF1      = 0x00000010,
            IN_LOAD_PICKER_VACUUM_OFF2      = 0x00000020,
            IN_LOAD_PICKER_VACUUM_OFF3      = 0x00000040,
            IN_LOAD_PICKER_VACUUM_OFF4      = 0x00000080,            //24
            //
            IN_UNLOAD_PICKER_VACUUM_ON1     = 0x00000001,                  //25
            IN_UNLOAD_PICKER_VACUUM_ON2     = 0x00000002,
            IN_UNLOAD_PICKER_VACUUM_ON3     = 0x00000004,
            IN_UNLOAD_PICKER_VACUUM_ON4     = 0x00000008,                  //28
            IN_UNLOAD_PICKER_VACUUM_OFF1    = 0x00000010,
            IN_UNLOAD_PICKER_VACUUM_OFF2    = 0x00000020,
            IN_UNLOAD_PICKER_VACUUM_OFF3    = 0x00000040,
            IN_UNLOAD_PICKER_VACUUM_OFF4    = 0x00000080                   //32
        };
