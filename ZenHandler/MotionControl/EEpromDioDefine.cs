...
namespace ZenHandler.MotionControl
{
    public class EEpromDioDefine : IDioDefine
    {
        ...
        public enum DIO_IN_ADDR_CH0 : uint
        {
            ...
            IN0_RIGHT_LIFT_COMPLETE_MODE            = 0x00000080,  //8
            //
            IN1_LIFT_LEFT_DOOR_LOCK_UP              = 0x00000001,  //9
            IN1_LIFT_LEFT_DOOR_LOCK_DOWN            = 0x00000002,
            IN1_LIFT_RIGHT_DOOR_LOCK_UP             = 0x00000004,
            IN1_LIFT_RIGHT_DOOR_LOCK_DOWN           = 0x00000008,  //12
            IN1_LEFT_LIFT_DOOR_CLOSE                = 0x00000010,
            IN1_RIGHT_LIFT_DOOR_CLOSE               = 0x00000020,
            IN1_NG_TRAY_DETECTED1                   = 0x00000040,
            IN1_NG_TRAY_DETECTED2                   = 0x00000080,  //16
            //
            IN2_WRITE_SOCKET_GOOD_DETECT1           = 0x00000001,  //17
            IN2_WRITE_SOCKET_GOOD_DETECT2           = 0x00000002,
            IN2_WRITE_SOCKET_GOOD_DETECT3           = 0x00000004,
            IN2_WRITE_SOCKET_GOOD_DETECT4           = 0x00000008,  //20
            IN2_VERIFY_SOCKET_GOOD_DETECT1          = 0x00000010,
            IN2_VERIFY_SOCKET_GOOD_DETECT2          = 0x00000020,
            IN2_VERIFY_SOCKET_GOOD_DETECT3          = 0x00000040,
            IN2_VERIFY_SOCKET_GOOD_DETECT4          = 0x00000080,  //24
            //
        ...
        public enum DIO_IN_ADDR_CH2 : uint
        {
            ...
            //
            IN3_TRANSFER_UNLOAD_PICKER_VACUUM_ON1   = 0x00000001,   //25
            IN3_TRANSFER_UNLOAD_PICKER_VACUUM_ON2   = 0x00000002,
            IN3_TRANSFER_UNLOAD_PICKER_VACUUM_ON3   = 0x00000004,
            IN3_TRANSFER_UNLOAD_PICKER_VACUUM_ON4   = 0x00000008,   //28
            TEMP29                                  = 0x00000010,
            TEMP30                                  = 0x00000020,
            TEMP31                                  = 0x00000040,
        ...
        public enum DIO_IN_ADDR_CH4 : uint
        {
            ...
            IN3_GANTRY_TRAY_DETECTED                = 0x00000010,
            IN3_PUSHER_TRAY_DETECTED                = 0x00000020,
            IN3_SOCKET_Y_FORWARD                    = 0x00000040,
            IN3_SOCKET_Y_BACKWARD                   = 0x00000080    //32
        };
        ...
        {
            IN0_WRITE_SOCKET_CONTACT_UP1            = 0x00000001,  //1
            IN0_WRITE_SOCKET_CONTACT_UP2            = 0x00000002,
            IN0_WRITE_SOCKET_CONTACT_UP3            = 0x00000004,
            IN0_WRITE_SOCKET_CONTACT_UP4            = 0x00000008,  //4
            IN0_WRITE_SOCKET_CONTACT_DOWN1          = 0x00000010,
            IN0_WRITE_SOCKET_CONTACT_DOWN2          = 0x00000020,
            IN0_WRITE_SOCKET_CONTACT_DOWN3          = 0x00000040,
            IN0_WRITE_SOCKET_CONTACT_DOWN4          = 0x00000080,  //8
            //
            IN1_WRITE_SOCKET_CONTACT_FORWARD1       = 0x00000001,  //9
            IN1_WRITE_SOCKET_CONTACT_FORWARD2       = 0x00000002,
            IN1_WRITE_SOCKET_CONTACT_FORWARD3       = 0x00000004,
            IN1_WRITE_SOCKET_CONTACT_FORWARD4       = 0x00000008,  //12
            IN1_WRITE_SOCKET_CONTACT_BACKWARD1      = 0x00000010,
            IN1_WRITE_SOCKET_CONTACT_BACKWARD2      = 0x00000020,
            IN1_WRITE_SOCKET_CONTACT_BACKWARD3      = 0x00000040,
            IN1_WRITE_SOCKET_CONTACT_BACKWARD4      = 0x00000080,  //16
            //
            IN2_VERIFY_SOCKET_CONTACT_UP1            = 0x00000001,  //17
            IN2_VERIFY_SOCKET_CONTACT_UP2            = 0x00000002,
            IN2_VERIFY_SOCKET_CONTACT_UP3            = 0x00000004,
            IN2_VERIFY_SOCKET_CONTACT_UP4            = 0x00000008,  //20
            IN2_VERIFY_SOCKET_CONTACT_DOWN1          = 0x00000010,
            IN2_VERIFY_SOCKET_CONTACT_DOWN2          = 0x00000020,
            IN2_VERIFY_SOCKET_CONTACT_DOWN3          = 0x00000040,
            IN2_VERIFY_SOCKET_CONTACT_DOWN4          = 0x00000080,  //24
            //
            IN3_VERIFY_SOCKET_CONTACT_FORWARD1       = 0x00000001,   //25
            IN3_VERIFY_SOCKET_CONTACT_FORWARD2       = 0x00000002,
            IN3_VERIFY_SOCKET_CONTACT_FORWARD3       = 0x00000004,
            IN3_VERIFY_SOCKET_CONTACT_FORWARD4       = 0x00000008,   //28
            IN3_VERIFY_SOCKET_CONTACT_BACKWARD1      = 0x00000010,
            IN3_VERIFY_SOCKET_CONTACT_BACKWARD2      = 0x00000020,
            IN3_VERIFY_SOCKET_CONTACT_BACKWARD3      = 0x00000040,
            IN3_VERIFY_SOCKET_CONTACT_BACKWARD4      = 0x00000080    //32
        };
        ...
        public enum DIO_OUT_ADDR_CH1 : uint
        {
            ...
            TEMP3 = 0x00000004,
            TEMP4 = 0x00000008,  //4
            OUT1_LEFT_LIFT_LOAD_MODE_LAMP           = 0x00000010,
            OUT1_LEFT_LIFT_COMPLETE_MODE_LAMP       = 0x00000020,
            OUT1_RIGHT_LIFT_LOAD_MODE_LAMP          = 0x00000040,
            OUT1_RIGHT_LIFT_COMPLETE_MODE_LAMP      = 0x00000080,  //8
            //
            OUT2_LIFT_LEFT_DOOR_LOCK_UP             = 0x00000001,  //9
            OUT2_LIFT_LEFT_DOOR_LOCK_DOWN           = 0x00000002,
            OUT2_LIFT_RIGHT_DOOR_LOCK_UP            = 0x00000004,
            OUT2_LIFT_RIGHT_DOOR_LOCK_DOWN          = 0x00000008,  //12
            TEMP13 = 0x00000010,
            TEMP14 = 0x00000020,
            TEMP15 = 0x00000040,
            TEMP16 = 0x00000080,  //16
        ...
        {
            OUT0_FRONT_GANTRY_CLAMP_FOR             = 0x00000001,  //1
            OUT0_FRONT_GANTRY_CLAMP_BACK            = 0x00000002,
            OUT0_BACK_GANTRY_CLAMP_FOR              = 0x00000004,
            OUT0_BACK_GANTRY_CLAMP_BACK             = 0x00000008,  //4
            OUT0_FRONT_GANTRY_CENTRING_FOR          = 0x00000010,
            OUT0_FRONT_GANTRY_CENTRING_BACK         = 0x00000020,
            OUT0_BACK_GANTRY_CENTRING_FOR           = 0x00000040,
            OUT0_BACK_GANTRY_CENTRING_BACK          = 0x00000080,  //8
            //
            OUT1_TRAY_PUSHER_LEFT_UP                = 0x00000001,  //9
            OUT1_TRAY_PUSHER_LEFT_DOWN              = 0x00000002,
            OUT1_TRAY_PUSHER_RIGHT_UP               = 0x00000004,
            OUT1_TRAY_PUSHER_RIGHT_DOWN             = 0x00000008,  //12
            OUT1_TRAY_PUSHER_LEFT_FOR               = 0x00000010,
            OUT1_TRAY_PUSHER_LEFT_BACK              = 0x00000020,
            OUT1_TRAY_PUSHER_RIGHT_FOR              = 0x00000040,
            OUT1_TRAY_PUSHER_RIGHT_BACK             = 0x00000080,  //16
            //                      
            OUT2_TRAY_PUSHER_CENTRING_LEFT_FOR      = 0x00000001,  //17
            OUT2_TRAY_PUSHER_CENTRING_LEFT_BACK     = 0x00000002,
            OUT2_TRAY_PUSHER_CENTRING_RIGHT_FOR     = 0x00000004,
            OUT2_TRAY_PUSHER_CENTRING_RIGHT_BACK    = 0x00000008,  //20
            TEMP21 = 0x00000010,
            TEMP22 = 0x00000020,
            TEMP23 = 0x00000040,
            TEMP24 = 0x00000080,  //24
            ...
            TEMP29 = 0x00000010,
            TEMP30 = 0x00000020,
            OUT3_SOCKET_Y_FORWARD                   = 0x00000040,
            OUT3_SOCKET_Y_BACKWARD                  = 0x00000080   //32
        };
        ...
        {
            OUT0_WRITE_SOCKET_CONTACT_UP1           = 0x00000001,  //1
            OUT0_WRITE_SOCKET_CONTACT_UP2           = 0x00000002,
            OUT0_WRITE_SOCKET_CONTACT_UP3           = 0x00000004,
            OUT0_WRITE_SOCKET_CONTACT_UP4           = 0x00000008,  //4
            OUT0_WRITE_SOCKET_CONTACT_DOWN1         = 0x00000010,
            OUT0_WRITE_SOCKET_CONTACT_DOWN2         = 0x00000020,
            OUT0_WRITE_SOCKET_CONTACT_DOWN3         = 0x00000040,
            OUT0_WRITE_SOCKET_CONTACT_DOWN4         = 0x00000080,  //8
            //
            OUT1_WRITE_SOCKET_CONTACT_FORWARD1      = 0x00000001,  //9
            OUT1_WRITE_SOCKET_CONTACT_FORWARD2      = 0x00000002,
            OUT1_WRITE_SOCKET_CONTACT_FORWARD3      = 0x00000004,
            OUT1_WRITE_SOCKET_CONTACT_FORWARD4      = 0x00000008,  //12
            OUT1_WRITE_SOCKET_CONTACT_BACKWARD1     = 0x00000010,
            OUT1_WRITE_SOCKET_CONTACT_BACKWARD2     = 0x00000020,
            OUT1_WRITE_SOCKET_CONTACT_BACKWARD3     = 0x00000040,
            OUT1_WRITE_SOCKET_CONTACT_BACKWARD4     = 0x00000080,  //16
            //                      
            OUT2_VERIFY_SOCKET_CONTACT_UP1          = 0x00000001,  //17
            OUT2_VERIFY_SOCKET_CONTACT_UP2          = 0x00000002,
            OUT2_VERIFY_SOCKET_CONTACT_UP3          = 0x00000004,
            OUT2_VERIFY_SOCKET_CONTACT_UP4          = 0x00000008,  //20
            OUT2_VERIFY_SOCKET_CONTACT_DOWN1        = 0x00000010,
            OUT2_VERIFY_SOCKET_CONTACT_DOWN2        = 0x00000020,
            OUT2_VERIFY_SOCKET_CONTACT_DOWN3        = 0x00000040,
            OUT2_VERIFY_SOCKET_CONTACT_DOWN4        = 0x00000080,  //24
            //
            OUT3_VERIFY_SOCKET_CONTACT_FORWARD1     = 0x00000001,  //25
            OUT3_VERIFY_SOCKET_CONTACT_FORWARD2     = 0x00000002,
            OUT3_VERIFY_SOCKET_CONTACT_FORWARD3     = 0x00000004,
            OUT3_VERIFY_SOCKET_CONTACT_FORWARD4     = 0x00000008,  //28
            OUT3_VERIFY_SOCKET_CONTACT_BACKWARD1    = 0x00000010,
            OUT3_VERIFY_SOCKET_CONTACT_BACKWARD2    = 0x00000020,
            OUT3_VERIFY_SOCKET_CONTACT_BACKWARD3    = 0x00000040,
            OUT3_VERIFY_SOCKET_CONTACT_BACKWARD4    = 0x00000080   //32
        };
    }//END
}
